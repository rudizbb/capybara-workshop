...
Then(/^I submit signup with a long email/) do
    @tests.signup_tests.signup_long_email
end

Then(/^I submit signup with a long project name/) do
    @tests.signup_tests.signup_long_project_name
end
